                ...
                <div className="row">
                    ...
                    <div className="single-service p-0 col-sm-12 col-md-12 col-lg-6" style={{marginTop: "100px", marginBottom: "100px"}}>
                        <div className="service-img">
                            <img style={{width: '100%'}} src={bike?.pic} alt="" />
                        </div>
                                ...
                                <div className=" text-center">
                                    ...
                                    <form onSubmit={handleSubmit(onSubmit)}>
                                        ...
                                        <div className="form-floating mb-3">
                                            <input {...register("email")} defaultValue={user.email} type="email" className="form-control" id="floatingInput" required placeholder=" "/>
